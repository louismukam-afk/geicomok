        ...
        <table   class="table  table-bordered table-striped table-condensed table-inverse" id="tableProduits" style="margin-top: 15px;">
            ...
            @foreach($produit as $p)
                <tr>
                   ...
                   {{-- <td>
                        <a href="{{route('securite_store_management',$p->id)}}" class="btn btn-warning btn-xs"> <span class="glyphicon glyphicon-link"></span> Stock minimum
                        </a>
                    </td>
                ...
                <div class="modal-content">
                    ...
                    <div
                        ...
                        <form accept-charset="UTF-8" id="edit_produit_form" role="form" method="POST" action="{{route('securite_update_management',$p->id)}}">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="numeric" id="edit_id" name="id_produit" >
                            <fieldset>
...
@section('breadcrumb')
    <ol class="breadcrumb" style="background-color: transparent;padding: 4px 10px">
        ...
        <li><a href="{{route('securite_stock_management')}}"><strong>STOCK MINIMUM</strong></a></li>
