...
@section('content')
    ...
    <div class="vente-container">
        ...
        <div class="container-fluid">
            ...
            <form action="{{route('store_approv')}}" id="form-facture" method="post">
                {{csrf_field()}}
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12" style="padding-top: 15px;margin-bottom: 10px">
                        <div class="form-group">
                            <label >Magasin: </label>
                            <select name="magasin" id="magasin"  form="form-facture" class="form-control" style="padding: 8px 20px 12px 20px;height: 40px">
                ...
                <div class="row-fluid">
                    ...
                    <button class="btn btn-success pull-right" onclick="validateFacture();"><span class="glyphicon glyphicon-ok-sign"></span> Approvisionner</button>
                </div>
            </form>
                        ...
                        if(lockPattern===data['pattern']){
                            ...
                            for(i=0;i<produits.length;i++){
                                ...
                                str+= '<li class="product-li">'+
                                    ...
                                    '<div class="col-md-6">'+
                                    ' <h4 class="product-quantite">Stock magasin : <strong> '+ produits[i].stock.quantite +'</strong></h4>'+
