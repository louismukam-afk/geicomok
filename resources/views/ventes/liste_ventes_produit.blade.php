...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <table class="table table-striped table-condensed table-inverse" style="margin-top: 15px;">
            ...
            @foreach($factures as $f)
                ...
                <tr>
                    ...
                    <td><a href="{{route('show_facture',$f->id)}}" class="text-warning">
                            <span class="glyphicon glyphicon-list-alt"></span> Facture</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
        ...
        <h4 class="alert alert-info">
            ...
            <div class="container">
                <h3 class="mb-4 text-primary">Ventes par produit avec bénéfices (groupé par client)</h3>

                @php
                    $beneficeGlobal = 0;
                @endphp

                @forelse($ventesParClient as $clientId => $clientData)
                    <div class="card mb-4">
                        ...
                        <div class="card-body p-0">
                            <table class="table table-bordered table-striped mb-0">
                                ...
                                <tr class="table-secondary">
                                    <td colspan="3" class="text-end"><strong>Total bénéfice client</strong></td>
                                    <td class="fw-bold">{{ number_format($beneficeClient, 0, ',', ' ') }} FCFA</td>
                                </tr>
                                @php
                                    $beneficeGlobal += $beneficeClient;
                                @endphp
                                </tbody>
                            </table>
                        </div>
