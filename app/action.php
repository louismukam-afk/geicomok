...
//              GESTION DES RAPPORTS
    ...
    const ACTION_COMPTABILITE_ENTREE_SPECIALE_INDEX = 'ACTION_COMPTABILITE_ENTREE_SPECIALE_INDEX';
    const ACTION_COMPTABILITE_ENTREE_SPECIALE_STORE = 'ACTION_COMPTABILITE_ENTREE_SPECIALE_STORE';
    const ACTION_COMPTABILITE_ENTREE_SPECIALE_REMBOURSEMENT = 'ACTION_COMPTABILITE_ENTREE_SPECIALE_REMBOURSEMENT';
    const ACTION_COMPTABILITE_ENTREE_SPECIALE_RAPPEL = 'ACTION_COMPTABILITE_ENTREE_SPECIALE_RAPPEL';
    ...
    public static function catalog()
    {
        $sections = [
            ...
            'Comptabilité' => [
                ...
                'Entrees speciales' => [
                    self::item(self::ACTION_COMPTABILITE_ENTREE_SPECIALE_INDEX, 'Voir'),
                    self::item(self::ACTION_COMPTABILITE_ENTREE_SPECIALE_STORE, 'Creer'),
                    self::item(self::ACTION_COMPTABILITE_ENTREE_SPECIALE_REMBOURSEMENT, 'Rembourser pret', true),
                    self::item(self::ACTION_COMPTABILITE_ENTREE_SPECIALE_RAPPEL, 'Voir rappels echeances'),
                ],
            ],
            'Accès global' => [
                'Super permissions' => [
